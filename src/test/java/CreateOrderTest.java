...
//без десериализатора, написан ради опыта, поэтому закоменчен, но оставлен в коде как 2 вариант
//    @Test
//    @DisplayName("Создать заказ с авторизацией")
//    @Description("У созданного заказа должен быть номер, код ответа 200")
//    public void createOrderWithAuthorization200() throws InterruptedException {
//        userClient.createUser(user);
//        user.setName(null);
//        Response response = userClient.loginUser(user);
//        userClient.setToken(response);
